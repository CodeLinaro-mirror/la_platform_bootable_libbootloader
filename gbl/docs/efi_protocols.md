...
See the documentation for Hash2Protocol and ServiceBindingProtocol for more
information.
...
with a minimal firmware modifications and still get some basic booting
functionality.
...
bites are reserved for future use.
